...
var reqData = [
	{text: "Lambert diffuse and Ambient material",
	...
	{text: "Lambert diffuse and Blinn specular",
	...
	{text: "No diffuse, ambient and Blinn specular",
	 sel: {	ambientType: "ambient",
			diffuseType: "none",
			specularType: "blinn",
			LAlightType: "direct",
	...
	{text: "Diffuse and Phong specular",
	 sel: {	ambientType: "none",
			diffuseType: "lambert",
			specularType: "phong",
			LAlightType: "direct",
	...
	{text: "Ambient + Oren-Nayar with roughness sigma=0.5, no specular (consider only Light A)",
	 sel: {	ambientType: "ambient",
			diffuseType: "lambert",
			specularType: "none",
			LAlightType: "direct",
