...
function InitTransforms() {
	...
	sTransformText[0] = "Rotate 45 degrees around an arbitrary axis passing through (1,0,-1). The x-axis can be aligned to the arbitrary axis after a rotation of 30 degrees around the z-axis, and then -60 degrees around the y-axis";
	...
	sTransformText[1] = "Half the size of an object, using as fixed point (5,0,-2)";
	...
	sTransformText[3] = "Apply the inverse of the following sequence of transforms: Translation of (0, 0, 5) then rotation of 30 degree around the Y axis, and finally a uniform scaling of a factor of 3";
